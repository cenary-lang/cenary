...
, cryptonite, directory, either, errors, filepath, hspec, indexed
, lens, monad-logger, mtl, optparse-applicative, parsec
, parsec-numbers, pretty-simple, process, stdenv, template-haskell
, text
}:
mkDerivation {
  pname = "ivy";
  ...
  testHaskellDepends = [ base directory filepath hspec mtl text ];
