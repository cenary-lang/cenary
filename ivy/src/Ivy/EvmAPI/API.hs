...
stop, add, mul, sub, div, mod, gt, lt, eq, iszero, pop, mload, mstore, mstore8, jump, jumpi, codecopy, dup1, exp, calldataload, dup2, dup3, swap1, swap2, log0, log1, log2, op_return, address :: OpcodeM m => m ()
